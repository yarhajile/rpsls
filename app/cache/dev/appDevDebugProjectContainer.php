...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'rpsls_helper' => 'getRpslsHelperService',
            ...
            'stats_helper' => 'getStatsHelperService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'rpsls', 'user' => 'rpsls', 'password' => 'rpsls', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    /**
     * Gets the 'rpsls_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Util\RpslsHelper A AppBundle\Util\RpslsHelper instance.
     */
    protected function getRpslsHelperService()
    {
        return $this->services['rpsls_helper'] = new \AppBundle\Util\RpslsHelper();
    }
    ...
    /**
     * Gets the 'stats_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Util\StatsHelper A AppBundle\Util\StatsHelper instance.
     */
    protected function getStatsHelperService()
    {
        return $this->services['stats_helper'] = new \AppBundle\Util\StatsHelper($this->get('doctrine.orm.default_entity_manager'));
    }
